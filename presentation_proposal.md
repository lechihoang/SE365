# Presentation Proposal: Progress Report Blueprint
...
**Ghi chú cho người trình bày:**
"Bộ dữ liệu không có sẵn mà được xây dựng từ đầu. Pipeline làm sạch loại bỏ hơn 1.100 review và gần 2.500 ảnh không hợp lệ. Nhãn overall_satisfaction được sinh bằng rule engine có bằng chứng giải thích — đây cũng là một đóng góp của dự án."
...
**Ghi chú cho người trình bày:**
"Kiến trúc gồm 3 nhánh chính. Hai encoder riêng biệt trích xuất đặc trưng từ text và image, sau đó fusion layer kết hợp chúng lại. Mỗi nhánh được huấn luyện riêng trước, rồi ghép lại và chỉ train phần fusion. Cách này giúp kiểm soát tốt và isolate đóng góp của từng thành phần."
...
**Tiêu đề:** Kiến trúc — Text Branch & Fusion Layer

**Mục tiêu:** Giải thích text processing và các fusion mechanism đã implement.
...
**Tiêu đề:** Phase 2 — Nghiên cứu Image Backbone
...
**Tiêu đề:** Phase 3 — Nghiên cứu Text Backbone
...
**Tiêu đề:** Phase 4 — Nghiên cứu Fusion Architecture

**Mục tiêu:** So sánh 5 cơ chế fusion và giải thích ý tưởng đằng sau mỗi cơ chế.
...
**Tiêu đề:** Phase 5 — Nghiên cứu Loss Function
...
**Tiêu đề:** Tóm tắt Kết quả — Cấu hình Tối ưu

**Mục tiêu:** Tổng hợp kết quả: cấu hình tốt nhất tìm được.
...
**Tiêu đề:** Kế hoạch Tiếp theo — Explainable AI

**Mục tiêu:** Trình bày kế hoạch XAI chi tiết, cho thấy đã suy nghĩ kỹ.
...
**Tiêu đề:** Dự kiến Đóng góp

**Mục tiêu:** Tổng hợp contribution của dự án.
...
**Ghi chú cho người trình bày:**
"Dự án đóng góp ở 3 cấp độ. Về mặt khoa học, phương pháp ablation có hệ thống cho 21 thí nghiệm. Về mặt kỹ thuật, toàn bộ pipeline từ crawl đến evaluate đã hoạt động. Về ứng dụng, hệ thống có thể giải thích dự đoán — đây là yêu cầu quan trọng trong thực tế."
